...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("youtube")
            .setDescription("The youtube channel")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("color")
            .setDescription("The server color")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("name")
            .setDescription("The Chosen Name")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
    ...
    option
    .setName("on-or-off")
    .setDescription("Select The Desired Option")
    .setRequired(true)
    )
    )
    ,
  async execute(interaction, client, args) {
    ...
    if (subcommand === "color") {
      ...
      console.log(color);
      await serverSchema.findOneAndUpdate({ guildID : interaction.guild.id},{serverColor : color})
      const embed = new EmbedBuilder()
        .setColor(option)
    ...
    if (subcommand == "name") {
      ...
      const user = await guild.members.cache.find(
